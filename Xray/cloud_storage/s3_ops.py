...
class S3Operation:
    ...
    def upload_file(
        ...
        """This method uploads the from_filename to bucket_name bucket with to_filename as bucket filename
        ...
        try:
            ...
            logging.info("Exited the upload_file methodo fS3Operation class")
